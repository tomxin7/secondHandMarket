...
<div id="content" style="margin-right: 100px;margin-top: 40px;">
    ...
    <div id="main">
        <form class="" method="post" action="<%=basePath%>admin/changePassword">
            ...
            <div class="row pass">
                <input type="password" id="password" name="password" placeholder="原密码" style="margin: 20px 0 10px 0"/>
            </div>
            <div class="row pass">
                <input type="password" id="password1" name="password1" placeholder="新密码" style="margin: 10px 0 20px 0"/>
            </div>
            <c:if test="${msg!=null}">
