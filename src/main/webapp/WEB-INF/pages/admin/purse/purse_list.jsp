...
<div id="content" style="margin-right: 100px; margin-top: 40px;">
    ...
    <div id="content-header">
        <div id="breadcrumb">
            ...
            <a title="充值列表" class="tip-bottom">充值钱包</a>
        </div>
    </div>
    <!--End-breadcrumbs-->
    ...
    <div class="container" style="width: 1000px;">
        ...
        <div class="col-lg-12">
            <h2 class="page-header" style="margin-top: 10px; text-align: center; font-family: '微软雅黑', Verdana, sans-serif, '宋体', serif;">钱包列表显示</h2>
        </div>

        <!--搜索栏-->
        <form class="form-horizontal" id="myserchform" name="myform" action="<%=basePath%>admin/searchPurse" method="post">
            ...
            <div class="pagination">
                <ul>
                    ...
                    <c:if test="${purseGrid.current ne 1 }">
                        <li>
                            <a href="<%=basePath%>admin/purseList?pageNum=${purseGrid.current-1 }">上一页</a>
                        </li>
                    </c:if>

                    <c:if test="${purseGrid.current < (purseGrid.total+9)/10-1 }">
                        <li>
                            <a href="<%=basePath%>admin/purseList?pageNum=${purseGrid.current+1 }">下一页</a>
                        </li>
                    </c:if>
                </ul>
            </div>
