...
<head>
    ...
    <script src="<%=basePath%>/js/user_password.js"></script>
</head>
<body>
<div id="loginbox">
    <h1 style="text-align:center;">校园二手工坊管理系统</h1>
    <form id="loginform" class="form-vertical" action="<%=basePath%>admin/index" method="post" role="form" onsubmit="return password2()">
        ...
        <div class="control-group">
            <div class="controls">
                <div class="main_input_box">
                    ...
                    <input type="text" name="phone" id="phone" class="required" value="" placeholder="账号"/>
                </div>
            </div>
        </div>
        <div class="control-group">
