...
<div id="content" style="margin-right: 100px; margin-top: 40px;">
    ...
    <div class="container" style="width: 1000px;">
        ...
        <div class="col-lg-12">
            <h2 class="page-header" style="margin-top: 10px; text-align: center; font-family: '微软雅黑', Verdana, sans-serif, '宋体', serif;">
                订单列表显示
            </h2>
        </div>
        ...
        <!--表格显示-->
        <table class="table sp-grid-import">
            <thead>
            <tr>
            ...
            <div class="modal-body" style="height: 0 auto;">
                <form class="form-horizontal" id="myeditform" name="myform">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
								<textarea rows="3" cols="20" name="orderInformation" style="margin-top: 8px; width: 365px"></textarea>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <select name="orderState" style="margin-top: 8px; width: 372px; height: 27px;">
            ...
            <div class="modal-body" style="height: 0 auto;">
                <form class="form-horizontal" id="myviewform" name="myform">
                    ...
                    <div class="form-group">
                        <label class="col-sm-4 control-label">订单编号:</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control" name="orderNum" readonly style="margin-top: 8px;"/>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-4 control-label">订单信息:</label>
                        <div class="col-sm-8">
								<textarea rows="3" cols="20" name="orderInformation" readonly style="margin-top: 8px; width: 365px"></textarea>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-4 control-label">订单价格:</label>
            ...
            success: function (json) {
                if (json) {
                    ...
                    if (json.orderState == 1) {
                        $('#myviewform').find("input[name='orderState']").val('待发货');
                    }
