...
<head>
    ...
    <script type="text/javascript" src="<%=basePath%>/js/user_password.js"></script>
    <script>
        function showLogin() {
            ...
            <div class="nav-wrapper search-bar">
                <form class="ng-pristine ng-invalid ng-invalid-required" action="<%=basePath%>goods/search">
                    <div class="input-field">
                        <input id="search" name="str" placeholder="搜点什么吧..." style="height: 40px;border-radius: 10px;"
                               class="ng-pristine ng-untouched ng-empty ng-invalid ng-invalid-required"/>
                        <input type="submit" class="btn" value="搜索" style="margin: -6px 0 0 5px;"/>
            ...
            <ul class="right">
                ...
                <c:if test="${empty cur_user}">
                    <li class="publish-btn">
                        <button onclick="showLogin()" data-toggle="tooltip" title="您需要先登录哦！"
    ...
    <div id="login-show" class="login stark-components">
        <div class="publish-box z-depth-4">
            <div class="row">
                ...
                <form action="<%=basePath%>user/login" method="post" role="form" onsubmit="return password1()">
                    ...
                    <a href="<%=basePath%>goods/homeGoods">
                        <div class="bannerimg">
                            <ul class="bannerul">
                                ...
                                <p class="text6">加入SecondHandMarket，你的大学，应更精彩。</p>
                            </ul>
                            <!--   <div class="logoimg">
