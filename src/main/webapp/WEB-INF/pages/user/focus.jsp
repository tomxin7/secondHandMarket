                        ...
                        <c:forEach var="items" items="${goodsAndImage}">
                            <div class="story">
                                ...
                                <div class="box">
                                    ...
                                    <div class="interact">
                                        <span class="fa fa-heart fa-lg" style="font-size: 16px; margin-right: 15px"><a
                                                href="<%=basePath%>goods/goodsId/${items.goods.id}">前往购买</a></span>
                                        <span class="fa fa-heart-o fa-lg" style="font-size: 16px;"><a
