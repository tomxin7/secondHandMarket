                        ...
                        <c:forEach var="items" items="${goodsAndImage}">
                            <div class="story">
                                <a href="<%=basePath%>goods/goodsId/${items.goods.id}" class="head_img">
                                    <img src="<%=basePath%>upload/${items.images[0].imgUrl}">
                                </a>
                                <span class="name" style="margin-left: 10px;">${items.goods.name}</span>
                                <span class="text"
                                ...
                                <div class="box">
                                    <div class="box_content">
                                        ...
                                        <img src="<%=basePath%>upload/${items.images[0].imgUrl}" index="2">
                                        <span class="com" style="display: none;left: 396.733px;"></span>
                                    </div>
                                    <div class="interact">
                                        <span class="fa fa-edit fa-lg" style="font-size: 16px;"><a
                                                href="<%=basePath%>goods/editGoods/${items.goods.id}">编辑</a></span>
                                        <span class="fa fa-share fa-lg" style="font-size: 16px;"><a
                                                href="<%=basePath%>goods/polishGoods/${items.goods.id}">擦亮</a></span>
                                            <%--  <span class="fa fa-commenting"><a>${items.comments.commetNum}</a></span> --%>
                                        <span class="time">发布时间：${items.goods.startTime}</span>
                                        <span class="fa fa-trash fa-lg" style="font-size: 16px; margin-left: 10px;"><a
                                                href="<%=basePath%>goods/deleteGoods/${items.goods.id}">下架</a></span>
                                    </div>
                                    <br>
                                    <div class="like_detail">
                                        <div class="like_content">
                                            <span>擦亮时间：${items.goods.polishTime}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
