...
public class OrdersController {
    ...
    public String addorders(HttpServletRequest request,Orders orders) throws UnsupportedEncodingException {
        ...
        //解决url中文乱码
        String s = orders.getOrderInformation();
        s = URLEncoder.encode(s, "ISO-8859-1");
        s = URLDecoder.decode(s, "UTF-8");
        orders.setOrderInformation(s);
